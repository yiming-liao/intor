...
//
// @public
export function getTranslator<CK extends TypedConfigKeys = "__default__", ReplacementShape = TypedReplacements<CK>, RichShape = TypedRich<CK>, PK extends LocalizedPreKey<TypedMessages<CK>> | undefined = undefined>(config: IntorConfig, request: FastifyRequest, params?: Omit<GetTranslatorParams, "locale"> & {
    preKey?: PK;
