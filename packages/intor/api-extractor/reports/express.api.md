...
// @public
export function getTranslator<CK extends GenConfigKeys = "__default__", ReplacementShape = GenReplacements<CK>, RichShape = GenRich<CK>, PK extends LocalizedPreKey<GenMessages<CK>> | undefined = undefined>(config: IntorConfig, req: Request_2, params?: Omit<GetTranslatorParams, "locale"> & {
    preKey?: PK;
