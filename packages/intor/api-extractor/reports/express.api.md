...
// @public
export function getTranslator<CK extends GenConfigKeys = "__default__", KM extends TranslatorKeyMode = "loose">(config: IntorConfig, req: Request_2, params?: Omit<GetTranslatorParams, "locale">): Promise<BaseTranslator<GenMessages<CK>, GenReplacements<CK>, GenRich<CK>, undefined, KM>>;

// @public (undocumented)
export function getTranslator<CK extends GenConfigKeys = "__default__", KM extends TranslatorKeyMode = "loose", PK extends LocalizedPreKey<GenMessages<CK>> = LocalizedPreKey<GenMessages<CK>>>(config: IntorConfig, req: Request_2, params: Omit<GetTranslatorParams, "locale"> & {
    preKey: PK;
