...
describe("IntorProvider", () => {
  ...
  it("calls side-effect hooks", async () => {
    const { useLocaleEffects } =
      await import("../../../../../src/client/react/provider/effects/use-locale-effects");
    const { useMessagesEffects } =
      await import("../../../../../src/client/react/provider/effects/use-messages-effects");
    renderWithProvider({
      config: baseConfig,
      locale: "en",
      messages: null,
