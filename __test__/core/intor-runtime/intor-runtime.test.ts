...
import { IntorErrorCode } from "../../../src/intor";
...
jest.mock(
  "../../../src/intor/core/intor-adapter/create-adapter-runtime-loader",
);
jest.mock("../../../src/intor/core/intor-messages-loader");
jest.mock(
  "../../../src/intor/core/intor-runtime/utils/should-load-dynamic-messages",
  () => ({
...
describe("intorRuntime", () => {
  ...
  beforeEach(() => {
    ...
    (createAdapterRuntimeLoader as jest.Mock).mockResolvedValue(
      mockAdapterRuntime,
    );
