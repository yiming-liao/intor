import type { Locale } from "../../../../src/intor/types/message-structure-types";
import { resolvePreferredLocale } from "../../../../src/intor/core/utils/locale/resolve-preferred-locale";
