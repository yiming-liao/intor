...
import { createResponse } from "@/adapters/next/routing/utils/create-response";
import { determineInitialLocale } from "@/adapters/next/routing/utils/determine-initial-locale";
